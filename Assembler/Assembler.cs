...
{
    protected LittleEndianAssembler(Language.Tokenizer tokenizer, int addressBitCount = 16) : base(tokenizer, addressBitCount) { }
...
{
    protected BigEndianAssembler(Language.Tokenizer tokenizer, int addressBitCount = 16) : base(tokenizer, addressBitCount) { }
